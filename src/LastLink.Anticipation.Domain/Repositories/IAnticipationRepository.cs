...
public interface IAnticipationRepository
{
    ...
    Task<AnticipationRequest?> GetByIdAsync(Guid id, CancellationToken ct = default);
    Task<AnticipationRequest?> GetByIdForUpdateAsync(Guid id, CancellationToken ct = default);
