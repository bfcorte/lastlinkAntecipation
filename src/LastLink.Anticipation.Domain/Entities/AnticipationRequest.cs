...
public class AnticipationRequest
{
    ...
    public void Approve() { if (Status != AnticipationStatus.Pending) throw new InvalidOperationException(); Status = AnticipationStatus.Approved; }
    public void Reject() { if (Status != AnticipationStatus.Pending) throw new InvalidOperationException(); Status = AnticipationStatus.Rejected; }
